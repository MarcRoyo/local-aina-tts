...
# RUN huggingface-cli download projecte-aina/matxa-tts-cat-multiaccent matcha_multispeaker_cat_bal_opset_15_10_steps.onnx --local-dir  $HOME/app/
# RUN huggingface-cli download projecte-aina/matxa-tts-cat-multiaccent matcha_multispeaker_cat_occ_opset_15_10_steps.onnx --local-dir  $HOME/app/
# RUN huggingface-cli download projecte-aina/matxa-tts-cat-multiaccent matcha_multispeaker_cat_val_opset_15_10_steps.onnx --local-dir  $HOME/app/
# RUN huggingface-cli download projecte-aina/matxa-tts-cat-multiaccent matcha_multispeaker_cat_cen_opset_15_10_steps.onnx --local-dir  $HOME/app/
